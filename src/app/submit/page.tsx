    ...
    <div className="container-page py-12">
      <div className="mx-auto max-w-2xl">
        <div className="text-center">
          <p className="flex items-center justify-center gap-1.5 text-sm font-semibold uppercase tracking-[0.1em] text-brand-700">
            <Megaphone aria-hidden className="h-4 w-4" strokeWidth={2.25} />
            Community submissions
          </p>
          <h1 className="display mt-3 text-[2rem] leading-tight text-ink sm:text-[2.75rem]">
            Submit an event
          </h1>
